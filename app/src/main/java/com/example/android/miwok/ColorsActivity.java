...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word ("Red","weṭeṭṭi",R.drawable.color_red,R.raw.color_red));    //creating an obj and adding it in the list...
        ...
        WordAdapter adapter = //stores our data and translates it into a list view and powers the listview..
                new WordAdapter(this,words,R.color.category_colors);  //calling the constructor in word.java and passing the views...
